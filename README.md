...
```json
{
  ...
  "stack": "Full-Stack",
  "DNA": {
    "cleanCode": "I write code as if the next developer is killer 🤺",
    "testing": "Tests are not optional"
  },
  "dependencies": {
    "coffee": "I must drink coffee ☕",
    "laptop": "I need laptop for develop 💻"
  }
}
```
<br />
...
<ul>
  ...
  <li style="font-size: 1.5rem;">🤤 The more complex the project, the more enjoyable it's for me.</li>
